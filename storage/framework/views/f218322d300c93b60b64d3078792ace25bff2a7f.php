        ...
        <div class="container">
            <div class="row">
                ...
                <div class="webads-image ">
                    ...
                    <img src="<?php echo e(url('/media/webads-image',$webads->image)); ?>" class="iresponsive" id="webads_image"></a>
                    <?php else: ?>
                     <img src="<?php echo e(url('/media/webads-image',$webads->image)); ?>" class="iresponsive" id="webads_image">
                     <?php endif; ?>
                <?php else: ?> 
                 <img src="<?php echo e(asset('website/images/dea/ad.png')); ?>" class="iresponsive">
                <?php endif; ?>
                </div>
            </div>
                                   ...
                                   <div class="product-media resimg">
                                       ...
                                       <div class="product-img">
                                           <?php if($premiumProduct->image): ?>
                                               <img src="<?php echo e(asset('media/product-image/' . $premiumProduct->image)); ?>"
                                                   alt="product">
                                           <?php else: ?><img src="<?php echo e(asset('website/images/no-image.png')); ?>"
                                                   alt="product">
                                           <?php endif; ?>
                                       </div>
                                       </a>
                                    ...
                                    <div class="product-media resimg">
                                        ...
                                        <div class="product-img">
                                            <?php if($auctionProduct->image): ?>
                                                <img src="<?php echo e(asset('media/product-image/' . $auctionProduct->image)); ?>"
                                                    alt="product">
                                            <?php else: ?><img src="<?php echo e(asset('website/images/no-image.png')); ?>"
                                                    alt="product">
                                            <?php endif; ?>
                                                    ...
                                                    <a href="<?php echo e(url('jobs-detail/'.$product->slug)); ?>">
                                                        <div class="product-img">
                                                            <?php if($product->image): ?>
                                                                <img src="<?php echo e(asset('media/product-image/' . $product->image)); ?>"
                                                                    alt="product">
                                                            <?php else: ?><img src="<?php echo e(asset('website/images/no-image.png')); ?>"
                                                                    alt="product">
                                                            <?php endif; ?>
                                        ...
                                        <div class="product-media resimg">
                                            ...
                                            <div class="product-img">
                                                <?php if($recommendedProduct->image): ?>
                                                    <img src="<?php echo e(asset('media/product-image/' . $recommendedProduct->image)); ?>"
                                                        alt="product">
                                                <?php else: ?><img src="<?php echo e(asset('website/images/no-image.png')); ?>"
                                                        alt="product">
                                                <?php endif; ?>
...
<?php echo $__env->make('website.layout.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /opt/lampp/htdocs/dealmih/resources/views/website/home.blade.php ENDPATH**/ ?>