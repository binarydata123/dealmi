...
<head>
   ...
   <link rel="icon" href="{{url('/media/faviconImg', $setting_data->favicon)}}">
   @else
         ...
         <div class="header-content">
            <div class="header-left">
               ...
               <a href="{{url('/')}}" class="header-logo">
                  ...
                  <img src="{{url('/media/websitelogo', $setting_data->site_logo)}}" class="po" alt="logo">
                  @else
                  <img src="{{asset('website/images/logo.png')}}" class="po" alt="logo">
                  @endif
               </a>
 ...
 -->
   ...
   <aside class="sidebar-part">
      <div class="sidebar-body">
         <div class="sidebar-header"><a href="{{ url('/') }}" class="sidebar-logo"><img src="{{ asset('website/images/logo.png') }}" alt="logo"></a><button class="sidebar-cross"><i class="fas fa-times"></i></button></div>
         ...
         <div class="modal-content">
            ...
            <div class="modal-body" align="center">
               ...
               <ul class="user-form-option">
                  <li><a href="{{url('auth/google')}}"><img src="{{asset('website/images/ui.svg')}}"><span> Sign in With Google</span></a></li>
